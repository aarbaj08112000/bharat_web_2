...
class User extends MY_Controller {
	...
	public function dashboard(){
		$data['rating_review'] = $this->User_model->get_rating_review();
		$data['category'] = $this->User_model->get_categories();
		$data['visitor'] = $this->User_model->get_visitor();
		$data['contact'] = $this->User_model->get_contact();
		$data['today_contact'] = $this->User_model->get_today_contact_count();
		$data['today_contact_count'] = count($this->User_model->get_today_contact_count());
		$data['today_visitor'] = $this->User_model->get_today_visitor_count();
		$data['today_visitor_count'] = count($this->User_model->get_today_visitor_count());
		$data['total_contact_count'] = count($data['contact']);
		$data['total_visitor_count'] = count($data['visitor']);
