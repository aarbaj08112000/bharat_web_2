...
<div class="content-wrapper">
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
      ...
      <div class="card p-0 mt-4 w-100">
        <div class="">
          ...
          <div class="table-responsive text-nowrap">
            <table width="100%" border="1" cellspacing="0" cellpadding="0" class="table table-striped" style="border-collapse: collapse;" border-color="#e1e1e1" id="contact_list">
              <thead>
                 <tr>
                    <!-- <th>Sr No</th> -->
                    <th>First Name</th>
              ...
              <tbody>
                 <%if ($contact) %>
                     ...
                     <tr>
                        ...
                        <td><%$u['subject'] %></td>
                        <td><%$u['message'] %></td>
                        <td><%$u['added_date']|date_format:"%d-%m-%Y" %></td>
                     </tr>
    ...
    <script src="<%$base_url%>public/js/admin_panel/contact_list.js"></script>
