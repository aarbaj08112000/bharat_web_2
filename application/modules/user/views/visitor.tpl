...
<div class="content-wrapper">
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
      ...
      <div class="card p-0 mt-4 w-100">
        <div class="">
          ...
          <div class="table-responsive text-nowrap">
            <table width="100%" border="1" cellspacing="0" cellpadding="0" class="table table-striped" style="border-collapse: collapse;" border-color="#e1e1e1" id="visitor_list">
              <thead>
                 <tr>
                    <!-- <th>Sr No</th> -->
                    <th>Name</th>
    ...
    <script src="<%$base_url%>public/js/admin_panel/visitor_list.js"></script>
