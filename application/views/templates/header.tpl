...
div:where(.swal2-icon) .swal2-icon-content {
   ...
   <body>
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme ">
         <div class="app-brand demo ps-3">
            ...
            <span class="app-brand-logo demo">
               <img src="<%base_url()%><%$config['company_logo']%>" alt="" width="150">
            </span>
         ...
         <li class="menu-item ">
         <a href="gallary" class="menu-link">
            <i class="menu-icon tf-icons bx bx-image-alt"></i>
            <div data-i18n="Analytics">Gallary Content</div>
         </a>
      </li>
      <li class="menu-item ">
         <a href="visitor" class="menu-link">
            <i class="menu-icon tf-icons bx bx-group"></i>
            <div data-i18n="Analytics">Visitor Listing</div>
         </a>
      </li>
      <li class="menu-item ">
         <a href="contact" class="menu-link">
            <i class="menu-icon tf-icons bx bx-user"></i>
            <div data-i18n="Analytics">Contact Listing</div>
         </a>
      </li>
         <li class="menu-item ">
         <a href="review" class="menu-link">
            <i class="menu-icon tf-icons bx bx-star"></i>
            <div data-i18n="Analytics">Rating & Review</div>
         </a>
      </li> -->
      <%assign var="current" value=$smarty.server.REQUEST_URI|basename%>

      <li class="menu-item <%if $current == 'dashboard'%>active<%/if%>">
         <a href="dashboard" class="menu-link">
            <i class="menu-icon tf-icons bx bx-home-circle"></i>
            <div data-i18n="Analytics">Dashboard</div>
         </a>
      ...
      <li class="menu-item <%if $current == 'banner'%>active<%/if%>">
         <a href="banner" class="menu-link">
            <i class="menu-icon tf-icons bx bx-dots-horizontal-rounded"></i>
            <div data-i18n="Analytics">Banner</div>
         </a>
      ...
      <li class="menu-item <%if $current == 'category'%>active<%/if%>">
         <a href="category" class="menu-link">
            <i class="menu-icon tf-icons bx bx-category"></i>
            <div data-i18n="Analytics">Category</div>
         </a>
      ...
      <li class="menu-item <%if $current == 'product'%>active<%/if%>">
         <a href="product" class="menu-link">
            <i class="menu-icon tf-icons bx bx-package"></i>
            <div data-i18n="Analytics">Product</div>
         </a>
      ...
      <li class="menu-item <%if $current == 'gallary'%>active<%/if%>">
         <a href="gallary" class="menu-link">
            <i class="menu-icon tf-icons bx bx-image-alt"></i>
            <div data-i18n="Analytics">Gallary Content</div>
         </a>
      ...
      <li class="menu-item <%if $current == 'visitor'%>active<%/if%>">
         <a href="visitor" class="menu-link">
            <i class="menu-icon tf-icons bx bx-group"></i>
            <div data-i18n="Analytics">Visitor Listing</div>
         </a>
      ...
      <li class="menu-item <%if $current == 'contact'%>active<%/if%>">
         <a href="contact" class="menu-link">
            <i class="menu-icon tf-icons bx bx-user"></i>
            <div data-i18n="Analytics">Contact Listing</div>
         </a>
      ...
      <li class="menu-item <%if $current == 'review'%>active<%/if%>">
         <a href="review" class="menu-link">
            <i class="menu-icon tf-icons bx bx-star"></i>
            <div data-i18n="Analytics">Rating & Review</div>
         </a>
...
">&nbsp;</p>
            ...
            <div class="navbar-right-wrap ms-2 d-flex nav-top-wrap navbar-nav login-nav-block login-nav-block-mobile">
               ...
               <img src="public/assets/images/user.png" onerror="imageLoadingError(this,'top-profile-image', 'S')" >
               </div>
            ...
            <%if !(strpos($smarty.server.PATH_INFO, "/sitemap") !== false) %>
            <div class="menu_show ms-3" style="display:none">
